      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="sticky top-32">
            <div className="bg-navy rounded-[2.5rem] p-12 text-white overflow-hidden relative">
              {/* Background accent */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-gold/10 rounded-full blur-3xl" />
              
              <h3 className="text-2xl font-bold mb-6">Why Choose NexSphere for {service.title}?</h3>
              <ul className="space-y-6">
                <li className="flex items-start space-x-4">
                  ...
                  <p className="text-slate-300 text-sm">
                    Technology-driven processes using modern accounting software.
                  </p>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center shrink-0">
